...
<form action="canned.php?<?php echo $qstr; ?>" method="post" id="save" enctype="multipart/form-data">
    ...
    <thead>
        <tr>
            <th colspan="2">
                ...
                <em>Configurações das respostas</em>
            </th>
        </tr>
    </thead>
    <tbody>
        <tr>
            ...
            <td>
                <input type="radio" name="isenabled" value="1" <?php echo $info['isenabled']?'checked="checked"':''; ?>>Habilitada
                <input type="radio" name="isenabled" value="0" <?php echo !$info['isenabled']?'checked="checked"':''; ?>>Desabilitada
        ...
        <tr>
            <th colspan="2">
                <em><strong>Resposta pré-estabelecida</strong>: Faça um título curto e claro.&nbsp;</em>
            </th>
        </tr>
        <tr>
            <td colspan=2>
                ...
                <br><br><div><b>Resposta</b> <font class="error">*&nbsp;<?php echo $errors['response']; ?></font>
                    &nbsp;&nbsp;&nbsp;(<a class="tip" href="ticket_variables">Variáveis suportadas</a>)</div>
                <textarea name="response" cols="21" rows="12" style="width: 80%;"><?php echo $info['response']; ?></textarea>
                <br><br><div><b>Anexos pré-estabelecidos</b> (opcional) <font class="error">&nbsp;<?php echo $errors['files']; ?></font></div>
                <?php
                ...
                <div class="faded">Você pode carregar até 10 anexos.</div>
            </td>
        </tr>
        <tr>
            <th colspan="2">
                <em><strong>Notas internas</strong>: Notas sobre as respostas.&nbsp;</em>
            </th>
        </tr>
        <tr>
            <td colspan=2>
 ...
 <?php if ($canned && $canned->getFilters()) { ?>
    <br/>
    <div id="msg_warning">A resposta está em uso pelo e-mail: <?php
